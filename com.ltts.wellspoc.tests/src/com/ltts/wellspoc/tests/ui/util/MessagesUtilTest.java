...
public class MessagesUtilTest extends TestCase {
	...
	public  void test_checkIfNumberValid() {
		...
		String text= "4000";
		 assertNotNull(text);
		 actualValue=messageUtil.checkIfNumber(text);
	...
	public void test_checkInLimit() {
		...
		Double maxValue=250.00;
		 ...
		 assertNotNull(text);
		 actualValue=messageUtil.checkInLimit(text, minValue, maxValue);
	...
	public void test_restrictEnteredChars() {
		...
		assertNotNull(text);
		actualValue=messageUtil.restrictEnteredChars(text, minValue, maxValue);
